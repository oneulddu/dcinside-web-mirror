...
| `MIRROR_MEDIA_MAX_BYTES` | `52428800` | 미디어 프록시 최대 응답 크기입니다. |
| `MIRROR_MEDIA_CHUNK_BYTES` | `262144` | 미디어 프록시 스트리밍/버퍼링 청크 크기입니다. |
| `MIRROR_MEDIA_STREAMING_MIN_BYTES` | `1048576` | 이 크기 이상의 길이를 아는 이미지/바이너리 응답은 스트리밍합니다. |
